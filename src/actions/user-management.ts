...
import { USER_STATUSES, UserModel, type UserStatus } from "@/lib/models/user";
import { saveEmployeeDocument } from "@/lib/uploads/employee-documents";
import type { UserManagementFormState } from "@/lib/auth/user-management-form-state";
...
export async function createManagedUser(
  ...
  try {
    ...
    return { error: "Only SUPER_ADMIN can create users." };
  }
